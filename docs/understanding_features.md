...
#### 1.3 Attention Backend Integration
...
```python
# Location: python/minisgl/engine/graph.py:136-141
...
1. **CUDA Graph**: Pre-captures decode-phase operations to eliminate CPU overhead
